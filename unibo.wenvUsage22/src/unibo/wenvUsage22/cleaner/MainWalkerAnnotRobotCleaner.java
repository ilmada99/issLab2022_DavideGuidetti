...
@Actor22(name = ApplData.robotName,contextName="pcCtx",implement = WalkerAnnotRobotCleaner.class)
//@Actor22(name = "sentinel",contextName="pcCtx",implement = Sentinel.class)
public class MainWalkerAnnotRobotCleaner { 
 ...
 */
	public static void main(String[] args) throws Exception   {
		CommUtils.aboutThreads("Before start - ");
 		new MainWalkerAnnotRobotCleaner().configure();
