...
public class SonarActor extends QakActor22 {
	...
	protected void elabCmd(IApplMessage msg) {
		...
		switch (msgCmd) {
		case ApplData.cmdActivateSonar:
			sonar.activate();
			break;
		case ApplData.cmdDeactivateSonar:
			sonar.deactivate();
			break;
		default:
	...
	protected void elabRequest(IApplMessage msg) {
		...
		case ApplData.reqSonarDistance: {
			IDistance curVal=sonar.getDistance();
			IApplMessage reply = MsgUtil.buildReply(getName(), ApplData.reqSonarDistance, "" + curVal.getVal(), msg.msgSender());
