...
public class ControllerForLedActor extends QakActor22 {
	...
	public ControllerForLedActor(String name) {
		super(name);
		// getStateRequest = Qak22Util.buildRequest(name,"ask", ApplData.reqLedState,
		// ApplData.ledName);
	}
	...
	protected void doControllerWork() {
		...
		if (numIter++ < 5) {
			...
			IApplMessage getStateRequest = Qak22Util.buildRequest(getName(), "ask", ApplData.reqLedState,
					ApplData.ledName);
