...
//Events
	...
	public static void registerAsEventObserver(String observer, String evId) {
		...
		if (a == null)
			new EventMsgHandler();
		IApplMessage m = CommUtils.buildDispatch(observer, registerForEvent, evId, EventMsgHandler.myName);
	...
	public static void unregisterAsEventObserver(String observer, String evId) {
		IApplMessage m = CommUtils.buildDispatch(observer, unregisterForEvent, evId, EventMsgHandler.myName);
		Qak22Util.sendAMsg(m, EventMsgHandler.myName); // Redirection to store
	}
